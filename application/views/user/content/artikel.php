<div role="main" class="ui-content jqm-content">
	...
	<?php foreach ($list as $row) { ?>
	 ...
	 <ul class="ui-group-theme-a ui-listview" data-role="listview" data-theme="a" data-dividertheme="b">
				<li class="">
				<a class="ui-btn ui-btn-icon-right ui-icon-carat-r" rel="external"  href="<?php echo base_url('user/artikel/detail/'.$row["id"]);?>">
					<img src="<?php echo base_url('asset/gambar/'.$row['gambar']); ?>"  >
					<h3><?= $row['judul'] ?></h3>
